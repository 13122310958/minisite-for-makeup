...
document.writeln("}");
document.writeln(".zx_link {width:96px;height:33px;display:block;position:absolute;right:20px;bottom:0; background: url(\"images/yuyue_1.png\"/*tpa=http://baidu.shhuamei.cn/js/images/yuyue_1.png*/) no-repeat;}");
document.writeln(".zx_link:hover {background: url(\"images/yuyue_2.png\"/*tpa=http://baidu.shhuamei.cn/js/images/yuyue_2.png*/) no-repeat;}");
...
document.writeln("		<img src=\"images/zzsj.jpg\"/*tpa=http://baidu.shhuamei.cn/js/images/zzsj.jpg*/ width=\"24\" height=\"157\">");
document.writeln("	</div>");
document.writeln("  <div class=\"cxTipBox-btn\" style=\"display:none;\">");
document.writeln("		<img src=\"images/zzsj_dt.jpg\"/*tpa=http://baidu.shhuamei.cn/js/images/zzsj_dt.jpg*/ width=\"288\" height=\"157\">");
document.writeln("		<a href=\"javascript:void(0)\" class=\"cxClose\" style=\"display:none;\">");
document.writeln("			<img src=\"images/close.jpg\"/*tpa=http://baidu.shhuamei.cn/js/images/close.jpg*/ width=\"11\" height=\"11\">");
document.writeln("		</a>");
document.writeln("		<a href=\"http://baidu.shhuamei.cn/call.html\" target=\"_blank\" class=\"zx_link\"></a>");
document.writeln("  </div>");
document.writeln("  <a href=\"javascript:void(0)\" class=\"closeTipBox\" style=\"display:none;\">");
document.writeln("		<img src=\"images/open.jpg\"/*tpa=http://baidu.shhuamei.cn/js/images/open.jpg*/ width=\"9\" height=\"32\">");
document.writeln("	</a> ");
document.writeln("</div>");
