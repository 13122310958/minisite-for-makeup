...
//左边
document.write("<div id=\"LRfloater0\" style=\"z-index:10000;width:130px;height:425px;left: 0px; top:120px; position:fixed; _position:absolute;*position:absolute;*bottom:auto;*top:expression(eval(document.documentElement.scrollTop + 100));\"><img id=\"LRfloater0close\" onclick=\"LRfloater0_hd();\" style=\"position:absolute;cursor:pointer; right:0px; top:0px;\" src=\"http://shrose.zoossoft.com/LR/closeimg/12.gif\"><img alt=\"如果您有什么问题,请点击此处进行即时沟通（上海玫瑰医疗美容医院专家团）\" src=\"http://www.021ylmr.com/swt/online_cn.gif\" style=\"cursor:pointer\" onclick=\"onSWT('swt_left');\"></div>");

//中间
document.write("<div id=\"LRfloater1\" style=\"z-index:10000; position: fixed !important; left: 50%; margin-left: -211px !important; top: 300px; margin-top: -100px !important;_top:expression(offsetParent.scrollTop+300); !important;*position:absolute;*bottom:auto; box-shadow:0px 3px 10px #494949;\"><img src=\"http://www.021ylmr.com/swt/online_swt.gif\" border=\"0\" usemap=\"#MapLR\"><map name=\"MapLR\"><area shape=\"rect\" coords=\"420,0,440,22\" href=\"javascript:void(0)\" onclick=\"LRfloater0_hd1();\"><area shape=\"rect\" coords=\"205,183,300,217\" href=\"javascript:onSWT('swt_center');\" alt=\"免费咨询\" /><area shape=\"rect\" coords=\"316,184,410,217\" href=\"javascript:onSWT('swt_center');\" alt=\"预约专家\" /><area shape=\"rect\" coords=\"11,25,432,180\" href=\"javascript:onSWT('swt_center');\" /></map></div>");
...
document.writeln("   </ul>");
document.writeln("   <span><a href=\"javascript:scroll(0,0);\"><img src=\"http://www.shrose.cn/swt/wx-swt2-pic.gif-06.gif\"></a></span>");
...
/*qq弹框*/
document.write('<style>#right_float_qq{bottom: 0px;right: 0px;z-index: 10000;position: fixed;_position:absolute;_top:expression(eval(document.documentElement.scrollTop+document.documentElement.clientHeight-this.offsetHeight-(parseInt(this.currentStyle.marginTop,2)||0)-(parseInt(this.currentStyle.marginBottom,2)||0)));}</style><div id="right_float_qq"><a href="javascript:onSWT(\'swt_foot\');"><img src="http://www.shrose.cn/swt/qqnews.gif" /></a></div>');
...
var _url = window.location.pathname;//获取完整URL	
	...
	if($(".wznr img").eq(0).attr("src").indexOf("bt3.png")==-1 && $(".wznr img").eq(0).attr("src").indexOf("bt4.png")==-1 && $(".wznr img").eq(0).attr("src").indexOf("alt_pc.png")==-1){
